...
import { RolePermissionController } from "../rolePermisson/controller.js";
import { addRolePermissionSchema, removeRolePermissionSchema, idParamSchema, roleParamSchema, permissionParamSchema, putRolePermissionSchema, patchRolePermissionSchema, } from "../rolePermisson/validators.js";
...
/* =========================
   GET BY ID (PK)
========================= */
router.get("/id/:id", validateParams(idParamSchema), RolePermissionController.getById);
/* =========================
   GET BY ROLE
========================= */
...
/* =========================
   DELETE BY ID
========================= */
router.delete("/id/:id", validateParams(idParamSchema), RolePermissionController.removeById);
/* =========================
...
router.put("/id/:id", validateParams(idParamSchema), validateBody(putRolePermissionSchema), RolePermissionController.putById);
/* =========================
   UPDATE (PATCH)
========================= */
router.patch("/id/:id", validateParams(idParamSchema), validateBody(patchRolePermissionSchema), RolePermissionController.patchById);
