...
import { createUserSchema, updateUserSchema, idParamSchema, queryUsersSchema, searchUserSchema, roleParamSchema } from "../user/validators.js";
...
router.put("/id/:id", validateParams(idParamSchema), validateBody(updateUserSchema), UserController.update);
router.patch("/id/:id", validateParams(idParamSchema), validateBody(updateUserSchema), UserController.update);
router.delete("/id/:id", validateParams(idParamSchema), UserController.delete);
