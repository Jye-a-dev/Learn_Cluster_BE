...
import { createNotificationSchema, notificationIdParamSchema, notificationUserParamSchema, bulkMarkAsReadSchema, queryNotificationsSchema, } from "../notification/validators.js";
...
/* ===== MARK AS READ (SINGLE) ===== */
router.patch("/id/:id/read", validateParams(notificationIdParamSchema), NotificationController.markAsRead);
/* ===== MARK ALL AS READ ===== */
...
/* ===== DELETE ONE ===== */
router.delete("/id/:id", validateParams(notificationIdParamSchema), NotificationController.delete);
/* ===== DELETE ALL BY USER ===== */
